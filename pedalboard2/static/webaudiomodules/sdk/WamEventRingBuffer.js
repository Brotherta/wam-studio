...
/** @typedef {import('../api').WamTransportEvent} WamTransportEvent */
/** @typedef {import('../api').WamMidiEvent} WamMidiEvent */
/** @typedef {import('../api').WamSysexEvent} WamSysexEvent */
/** @typedef {import('../api').WamMpeEvent} WamMpeEvent */
/** @typedef {import('../api').WamOscEvent} WamOscEvent */
/** @typedef {import('../api').WamInfoEvent} WamInfoEvent */
...
/** @typedef {import('../api').WamInfoData} WamInfoData */
