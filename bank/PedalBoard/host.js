...
(async () => {
  // Init WamEnv
  const { default: initializeWamHost } = await import("http://localhost:7002/plugins/utils/sdk/src/initializeWamHost.js");
  const [hostGroupId] = await initializeWamHost(audioContext);

  // Import WAM
  const { default: WAM } = await import("http://localhost:7002/src/index.js");
