...
<div class="pedal draggable" style="box-sizing: border-box; transform: translate(13.3164px, -282.883px);" id="pedal" data-x="13.31640625" data-y="-282.8828125">
  ...
  handleAnimationFrame = () => {
    this._root.getElementById("/StonePhaserStereo/LFO").value =
      this._plug.audioNode.getParamValue("/StonePhaserStereo/LFO");

    this._root.getElementById("/StonePhaserStereo/Feedback").value =
      this._plug.audioNode.getParamValue("/StonePhaserStereo/Feedback");

    this._root.getElementById("/StonePhaserStereo/Lo-cut").value =
      this._plug.audioNode.getParamValue("/StonePhaserStereo/Lo-cut");
