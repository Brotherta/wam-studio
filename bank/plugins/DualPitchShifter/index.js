...
class DualPitchShifterNode extends CompositeAudioNode {
  _wamNode;
...
export default class DualPitchShifterPlugin extends WebAudioModule {
  _PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new DualPitchShifterNode(this.audioContext);
