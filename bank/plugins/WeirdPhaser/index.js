...
class weirdPhaserNode extends CompositeAudioNode {
  _wamNode;
...
export default class weirdPhaserPlugin extends WebAudioModule {
  _PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new weirdPhaserNode(this.audioContext);
