...
class ThruZeroFlangerNode extends CompositeAudioNode {
  _wamNode;
...
export default class ThruZeroFlangerPlugin extends WebAudioModule {
  _PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new ThruZeroFlangerNode(this.audioContext);
