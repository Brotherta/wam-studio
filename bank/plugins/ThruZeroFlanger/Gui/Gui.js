...
export default class ThruZeroFlangerGui extends HTMLElement {
  ...
  handleAnimationFrame = () => {
    this._root.getElementById("/ThruZeroFlanger/Delay").value =
      this._plug.audioNode.getParamValue("/ThruZeroFlanger/Delay");

    this._root.getElementById("/ThruZeroFlanger/Depth").value =
      this._plug.audioNode.getParamValue("/ThruZeroFlanger/Depth");

    this._root.getElementById("/ThruZeroFlanger/L-ROffset").value =
      this._plug.audioNode.getParamValue("/ThruZeroFlanger/L-ROffset");

    this._root.getElementById("/ThruZeroFlanger/Rate").value =
      this._plug.audioNode.getParamValue("/ThruZeroFlanger/Rate");

    this._root.getElementById("/ThruZeroFlanger/bypass").value =
      1 - this._plug.audioNode.getParamValue("/ThruZeroFlanger/bypass");
  ...
  setKnobs() {
    this._root
      .getElementById("/ThruZeroFlanger/Delay")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/ThruZeroFlanger/Delay",
          e.target.value,
        ),
      );
    this._root
      .getElementById("/ThruZeroFlanger/Depth")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/ThruZeroFlanger/Depth",
          e.target.value,
        ),
      );
    this._root
      .getElementById("/ThruZeroFlanger/L-ROffset")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/ThruZeroFlanger/L-ROffset",
          e.target.value,
        ),
      );
    this._root
      .getElementById("/ThruZeroFlanger/Rate")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/ThruZeroFlanger/Rate",
          e.target.value,
        ),
      );
  }
  ...
  setSwitches() {
    this._root
      .getElementById("/ThruZeroFlanger/bypass")
      .addEventListener("change", (e) =>
        this._plug.audioNode.setParamValue(
          "/ThruZeroFlanger/bypass",
          1 - e.target.value,
        ),
      );
  }
...
try {
  customElements.define("wap-thruzeroflanger", ThruZeroFlangerGui);
} catch (error) {
  console.log(error);
