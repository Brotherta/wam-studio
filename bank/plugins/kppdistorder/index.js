...
class compressorNode extends CompositeAudioNode {
  _wamNode;
...
export default class compressorPlugin extends WebAudioModule {
  _PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new compressorNode(this.audioContext);
