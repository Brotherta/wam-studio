...
<div class="webaudio-switch-body" tabindex="1" touch-action="none" style="background-image: url(&quot;/./img/switches/switch_1.png&quot;); background-size: 100% 200%; width: 64px; height: 40px; outline: currentcolor none medium; background-position: 0px -100%;"><div class="webaudioctrl-tooltip" style="transition: opacity 0.1s ease 0s, visibility 0.1s ease 0s; opacity: 0; visibility: hidden;"></div></div>
  ...
  handleAnimationFrame = () => {
    this._root.getElementById("/untitled/DECAY").value =
      this._plug.audioNode.getParamValue("/untitled/DECAY");

    this._root.getElementById("/untitled/MIX").value =
      this._plug.audioNode.getParamValue("/untitled/MIX");

    this._root.getElementById("/untitled/SHIMMER").value =
      this._plug.audioNode.getParamValue("/untitled/SHIMMER");

    this._root.getElementById("/untitled/TONE").value =
      this._plug.audioNode.getParamValue("/untitled/TONE");
  ...
  setKnobs() {
    this._root
      ...
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue("/untitled/DECAY", e.target.value),
      );
    this._root
      .getElementById("/untitled/MIX")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue("/untitled/MIX", e.target.value),
      );
    this._root
      .getElementById("/untitled/SHIMMER")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue("/untitled/SHIMMER", e.target.value),
      );
    this._root
      .getElementById("/untitled/TONE")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue("/untitled/TONE", e.target.value),
      );
  }
