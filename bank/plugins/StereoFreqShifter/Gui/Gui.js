...
export default class StereoFreqShifterGui extends HTMLElement {
  ...
  handleAnimationFrame = () => {
    this._root.getElementById("/StereoFreqShifter/L-ROffset").value =
      this._plug.audioNode.getParamValue("/StereoFreqShifter/L-ROffset");

    this._root.getElementById("/StereoFreqShifter/Mix").value =
      this._plug.audioNode.getParamValue("/StereoFreqShifter/Mix");

    this._root.getElementById("/StereoFreqShifter/ShiftScalar").value =
      this._plug.audioNode.getParamValue("/StereoFreqShifter/ShiftScalar");

    this._root.getElementById("/StereoFreqShifter/Shift").value =
      this._plug.audioNode.getParamValue("/StereoFreqShifter/Shift");

    this._root.getElementById("/StereoFreqShifter/bypass").value =
      1 - this._plug.audioNode.getParamValue("/StereoFreqShifter/bypass");
  ...
  setKnobs() {
    this._root
      .getElementById("/StereoFreqShifter/L-ROffset")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/StereoFreqShifter/L-ROffset",
          e.target.value,
        ),
      );
    this._root
      .getElementById("/StereoFreqShifter/Mix")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/StereoFreqShifter/Mix",
          e.target.value,
        ),
      );
    this._root
      .getElementById("/StereoFreqShifter/ShiftScalar")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/StereoFreqShifter/ShiftScalar",
          e.target.value,
        ),
      );
    this._root
      .getElementById("/StereoFreqShifter/Shift")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/StereoFreqShifter/Shift",
          e.target.value,
        ),
      );
  }
  ...
  setSwitches() {
    this._root
      .getElementById("/StereoFreqShifter/bypass")
      .addEventListener("change", (e) =>
        this._plug.audioNode.setParamValue(
          "/StereoFreqShifter/bypass",
          1 - e.target.value,
        ),
      );
  }
...
try {
  customElements.define("wap-stereofreqshifter", StereoFreqShifterGui);
  // ;
} catch (error) {
  // console.log(error);
