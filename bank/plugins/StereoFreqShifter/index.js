...
class StereoFreqShifterNode extends CompositeAudioNode {
  _wamNode;
...
export default class StereoFreqShifterPlugin extends WebAudioModule {
  _PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new StereoFreqShifterNode(this.audioContext);
