...
export const WamParameterInterpolator: {
  ...
  new (
    ...
    samplesPerInterpolation: number,
    skew?: number,
...
export const WamEventRingBuffer: {
   ...
   */
  getStorageForEventCapacity(
    RingBufferConstructor: typeof RingBuffer,
...
export interface WamNode
  extends IWamNode,
    Omit<AudioWorkletNode, "addEventListener" | "removeEventListener"> {
...
export interface WamProcessor extends IWamProcessor {
  ...
  _setParameterValues(
    parameterUpdates: WamParameterDataMap,
    interpolate: boolean,
  ): void;
  _setParameterValue(
    parameterUpdate: WamParameterData,
    interpolate: boolean,
  ): void;
...
export interface WebAudioModule<Node extends IWamNode = IWamNode>
  extends IWebAudioModule<Node> {
...
export const WebAudioModule: {
  ...
  new <Node extends IWamNode = IWamNode>(
    groupId: string,
    audioContext: BaseAudioContext,
  ): WebAudioModule<Node>;
