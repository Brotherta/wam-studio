...
class smoothDelayNode extends CompositeAudioNode {
  _wamNode;
...
export default class smoothDelayPlugin extends WebAudioModule {
  _PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new smoothDelayNode(this.audioContext);
