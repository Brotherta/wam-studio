...
<div class="webaudio-switch-body" tabindex="1" touch-action="none" style="background-image: url(&quot;./img/switches/switch_1.png&quot;); background-size: 100% 200%; width: 64px; height: 40px; outline: none; background-position: 0px -100%;"><div class="webaudioctrl-tooltip" style="transition: opacity 0.1s ease 0s, visibility 0.1s ease 0s; opacity: 0; visibility: hidden;"></div></div>
  ...
  handleAnimationFrame = () => {
    this._root.getElementById("/greyhole/Greyhole/Dry/Wet").value =
      this._plug.audioNode.getParamValue("/greyhole/Greyhole/Dry/Wet");

    this._root.getElementById("/greyhole/Greyhole/damping").value =
      this._plug.audioNode.getParamValue("/greyhole/Greyhole/damping");

    this._root.getElementById("/greyhole/Greyhole/delayTime").value =
      this._plug.audioNode.getParamValue("/greyhole/Greyhole/delayTime");

    this._root.getElementById("/greyhole/Greyhole/diffusion").value =
      this._plug.audioNode.getParamValue("/greyhole/Greyhole/diffusion");

    this._root.getElementById("/greyhole/Greyhole/feedback").value =
      this._plug.audioNode.getParamValue("/greyhole/Greyhole/feedback");

    this._root.getElementById("/greyhole/Greyhole/modDepth").value =
      this._plug.audioNode.getParamValue("/greyhole/Greyhole/modDepth");

    this._root.getElementById("/greyhole/Greyhole/modFreq").value =
      this._plug.audioNode.getParamValue("/greyhole/Greyhole/modFreq");

    this._root.getElementById("/greyhole/Greyhole/size").value =
      this._plug.audioNode.getParamValue("/greyhole/Greyhole/size");

    this._root.getElementById("/greyhole/bypass").value =
      1 - this._plug.audioNode.getParamValue("/greyhole/bypass");
  ...
  setKnobs() {
    this._root
      .getElementById("/greyhole/Greyhole/Dry/Wet")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/greyhole/Greyhole/Dry/Wet",
          e.target.value,
        ),
      );
    this._root
      .getElementById("/greyhole/Greyhole/damping")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/greyhole/Greyhole/damping",
          e.target.value,
        ),
      );
    this._root
      .getElementById("/greyhole/Greyhole/delayTime")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/greyhole/Greyhole/delayTime",
          e.target.value,
        ),
      );
    this._root
      .getElementById("/greyhole/Greyhole/diffusion")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/greyhole/Greyhole/diffusion",
          e.target.value,
        ),
      );
    this._root
      .getElementById("/greyhole/Greyhole/feedback")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/greyhole/Greyhole/feedback",
          e.target.value,
        ),
      );
    this._root
      .getElementById("/greyhole/Greyhole/modDepth")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/greyhole/Greyhole/modDepth",
          e.target.value,
        ),
      );
    this._root
      .getElementById("/greyhole/Greyhole/modFreq")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/greyhole/Greyhole/modFreq",
          e.target.value,
        ),
      );
    this._root
      .getElementById("/greyhole/Greyhole/size")
      .addEventListener("input", (e) =>
        this._plug.audioNode.setParamValue(
          "/greyhole/Greyhole/size",
          e.target.value,
        ),
      );
  }
  ...
  setSwitches() {
    this._root
      .getElementById("/greyhole/bypass")
...
try {
  customElements.define("wap-greyhole", greyholeGui);
} catch (error) {
  console.log(error);
