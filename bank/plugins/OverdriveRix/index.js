...
class OverdriveRixNode extends CompositeAudioNode {
  _wamNode;
...
export default class OverdriveRixPlugin extends WebAudioModule {
  _PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new OverdriveRixNode(this.audioContext);
