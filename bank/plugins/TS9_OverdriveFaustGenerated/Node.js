  ...
  ctrlChange(channel, ctrl, value) {
    if (this.fCtrlLabel[ctrl] !== []) {
      for (var i = 0; i < this.fCtrlLabel[ctrl].length; i++) {
        ...
        this.setParamValue(
          path,
          TS9_OverdriveFaustGeneratedNode.remap(
            value,
            0,
            127,
...
// Factory class
export default class TS9_OverdriveFaustGenerated {
