  ...
  async createAudioNode(initialState) {
    ...
    const internalParamsConfig = {
      ...
      presence: {
        ...
        maxValue: 10,
        onChange: (value) => {
          distoMachineNode.presence = value;
        },
      },
      /*
			midHighGain: {
