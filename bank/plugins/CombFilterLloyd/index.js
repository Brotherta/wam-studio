...
class CombFilterLloydNode extends CompositeAudioNode {
  _wamNode;
...
export default class CombFilterLloydPlugin extends WebAudioModule {
  _PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new CombFilterLloydNode(this.audioContext);
