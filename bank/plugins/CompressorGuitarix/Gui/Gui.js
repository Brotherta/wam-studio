...
<div class="webaudio-switch-body" tabindex="1" touch-action="none" style="background-image: url(&quot;./img/switches/switch_1.png&quot;); background-size: 100% 200%; width: 64px; height: 40px; outline: none; background-position: 0px 0px;"><div class="webaudioctrl-tooltip" style="transition: opacity 0.1s ease 0s, visibility 0.1s ease 0s; opacity: 0; visibility: hidden;"></div></div>
      ...
      // check if the shadowroot host has a background image
        ...
        this._root.getElementById('/CompressorGuitarix/Compressor/3-gain/Makeup_Gain').value = this._plug.audioNode.getParamValue('/CompressorGuitarix/Compressor/3-gain/Makeup_Gain');
        

        this._root.getElementById('/CompressorGuitarix/Compressor/Attack').value = this._plug.audioNode.getParamValue('/CompressorGuitarix/Compressor/Attack');
        

        this._root.getElementById('/CompressorGuitarix/Compressor/Dry/Wet').value = this._plug.audioNode.getParamValue('/CompressorGuitarix/Compressor/Dry/Wet');
        

        this._root.getElementById('/CompressorGuitarix/Compressor/Knee').value = this._plug.audioNode.getParamValue('/CompressorGuitarix/Compressor/Knee');
        

        this._root.getElementById('/CompressorGuitarix/Compressor/Ratio').value = this._plug.audioNode.getParamValue('/CompressorGuitarix/Compressor/Ratio');
        

        this._root.getElementById('/CompressorGuitarix/Compressor/Release').value = this._plug.audioNode.getParamValue('/CompressorGuitarix/Compressor/Release');
        

        this._root.getElementById('/CompressorGuitarix/Compressor/Threshold').value = this._plug.audioNode.getParamValue('/CompressorGuitarix/Compressor/Threshold');
...
window.requestAnimationFrame(this.handleAnimationFrame);
        ...
        return ['state'];
              ...
              setKnobs() {
                 this._root.getElementById("/CompressorGuitarix/Compressor/3-gain/Makeup_Gain").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/CompressorGuitarix/Compressor/3-gain/Makeup_Gain", e.target.value));
this._root.getElementById("/CompressorGuitarix/Compressor/Attack").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/CompressorGuitarix/Compressor/Attack", e.target.value));
this._root.getElementById("/CompressorGuitarix/Compressor/Dry/Wet").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/CompressorGuitarix/Compressor/Dry/Wet", e.target.value));
this._root.getElementById("/CompressorGuitarix/Compressor/Knee").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/CompressorGuitarix/Compressor/Knee", e.target.value));
this._root.getElementById("/CompressorGuitarix/Compressor/Ratio").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/CompressorGuitarix/Compressor/Ratio", e.target.value));
this._root.getElementById("/CompressorGuitarix/Compressor/Release").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/CompressorGuitarix/Compressor/Release", e.target.value));
this._root.getElementById("/CompressorGuitarix/Compressor/Threshold").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/CompressorGuitarix/Compressor/Threshold", e.target.value));
