...
export function getVoidPlayerProcessor(moduleId:string){
    ...
    class VoidPlayerProcessor extends BaseAudioPlayerProcessor implements IBaseAudioPlayerProcessor {
    ...
    try{ registerProcessor(moduleId, VoidPlayerProcessor) } catch(e){}
}